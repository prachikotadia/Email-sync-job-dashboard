...
def create_progress_event(
    ...
    log_message: Optional[str] = None,  # Detailed log message for UI
    log_type: Optional[str] = None  # Log type: 'info', 'success', 'warning', 'error'
) -> Dict[str, Any]:
    """
    ...
    event = {
        ...
        "log_type": log_type or level  # Log type: 'info', 'success', 'warning', 'error'
    }
    return event
